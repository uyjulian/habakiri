...
public interface SimpleOptionProvider {

	public int getAsNumber( /*in*/final String name, /*out*/long[] value );
		// retrieve option as a number.

	public int getAsString( /*in*/final String name, /*out*/String[] out );
	...
	public int getValue( /*in*/final String name, /*out*/Variant dest );
