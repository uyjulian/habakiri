...
public class ControllerClass extends NativeClass {

	static int mClassID = -1;
	static private final String CLASS_NAME = "Controller";

	protected NativeInstance createNativeInstance() {
		return null;
	}

	public ControllerClass() throws VariantException, TJSException {
		super( CLASS_NAME );
