...
public class PhaseVocoderClass extends NativeClass {

	static int mClassID = -1;
	static private final String CLASS_NAME = "PhaseVocoder";

	protected NativeInstance createNativeInstance() {
		return null;
	}

	public PhaseVocoderClass() throws VariantException, TJSException {
		super( CLASS_NAME );
		...
		registerNCM( "window", TVP.NotImplProp, CLASS_NAME, Interface.nitProperty, 0 );
		registerNCM( "overlap", TVP.NotImplProp, CLASS_NAME, Interface.nitProperty, 0 );
		registerNCM( "pitch", TVP.NotImplProp, CLASS_NAME, Interface.nitProperty, 0 );
		registerNCM( "time", TVP.NotImplProp, CLASS_NAME, Interface.nitProperty, 0 );
	}
