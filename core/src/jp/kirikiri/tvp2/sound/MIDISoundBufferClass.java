...
public class MIDISoundBufferClass extends NativeClass {

	static int mClassID = -1;
	static private final String CLASS_NAME = "MIDISoundBuffer";

	protected NativeInstance createNativeInstance() {
		return null;
	}

	public MIDISoundBufferClass() throws VariantException, TJSException {
		super( CLASS_NAME );
		...
		registerNCM( "midiOut", TVP.NotImplMethod, CLASS_NAME, Interface.nitMethod, 0 );
