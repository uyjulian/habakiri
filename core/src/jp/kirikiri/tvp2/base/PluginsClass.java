...
public class PluginsClass extends NativeClass {
	...
	public PluginsClass() throws VariantException, TJSException {
		...
		registerNCM( "link", TVP.ReturnOKMethod, CLASS_NAME, Interface.nitMethod, Interface.STATICMEMBER );
		registerNCM( "unlink", TVP.ReturnOKMethod, CLASS_NAME, Interface.nitMethod, Interface.STATICMEMBER );
		registerNCM( "getList", TVP.ReturnOKMethod, CLASS_NAME, Interface.nitMethod, Interface.STATICMEMBER );
	}
