...
public class SimpleGetSetProperty extends Dispatch {
	...
	public int propGet( int flag, final String membername, Variant result, Dispatch2 objthis ) {
		if( membername != null ) return Error.E_MEMBERNOTFOUND;
		if( result != null ) result.set( mValue );
		return Error.S_OK;
	}

	public int propSet( int flag, String membername, final Variant param, Dispatch2 objThis ) {
		if( membername != null ) return Error.E_MEMBERNOTFOUND;
		mValue.set( param );
		return Error.S_OK;
	}
